...
def build_parser():
    ...
    parser.add_argument("json_folder_positional", help="folder containing json to upload.")
    ...
    parser.add_argument("mbtiles_file_positional", help="mbtiles file to upload, as a positional argument")
